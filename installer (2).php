...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'enolawinesEnd_1cc452714d7a529d4809_20230208101350_archive.zip';
        const ARCHIVE_SIZE       = '60199048';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1cc4527-08101350';
        const SECONDARY_PACKAGE_HASH = '1430183-08101350';
